...
public class SearchBeaconActivity extends BaseActivity {

    private static final String TAG = SearchBeaconActivity.class.getSimpleName();
    ...
    protected int getLayoutResId() {
        return R.layout.search_beacons_view;
    }
